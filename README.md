...
Далее по кричим `ansible-playbook web_conf.yml`, устанавливаем джинсы и файлбит с настройками жижи2:
...
И остался только заббикс `ansible-palybook zabbix.yml`

Файл zabbix_conf.yml:
